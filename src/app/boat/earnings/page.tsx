  ...
  return (
    <div className="max-w-3xl">
      <div className="flex items-center justify-between mb-6">
        ...
        {available > 0 && (
          <Button variant="primary" size="sm" onClick={() => { setPayoutOpen(true); setPayoutPhone(""); }}>
            ...
            {history.map((h) => (
              <div key={h.id} className="flex items-center gap-3 justify-between py-3 border-b border-gray-50 last:border-0">
                <div className="min-w-0">
                  ...
                  <p className="font-josefin text-gray-400 text-xs">{h.passengers} passengers · {h.customerName}</p>
                </div>
