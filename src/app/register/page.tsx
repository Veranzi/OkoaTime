...
import { Eye, EyeOff, ShoppingCart, Store, Bike, Sailboat, type LucideIcon } from "lucide-react";
...
const roles: { value: UserRole; label: string; icon: LucideIcon; desc: string }[] = [
  { value: "customer", label: "Customer", icon: ShoppingCart, desc: "Order deliveries" },
  { value: "supplier", label: "Supplier", icon: Store, desc: "Sell your products" },
  { value: "rider", label: "Rider", icon: Bike, desc: "Deliver orders" },
  { value: "boat", label: "Boat Operator", icon: Sailboat, desc: "Offer boat transport" },
];
        ...
        <form onSubmit={handleSubmit(onSubmit as Parameters<typeof handleSubmit>[0])} className="bg-white rounded-3xl shadow-card p-8 space-y-6">
          ...
          {role === "supplier" && (
            <div className="bg-orange-50 rounded-2xl p-4 space-y-4">
              <p className="font-outfit font-semibold text-orange text-sm flex items-center gap-1.5"><Store className="w-4 h-4" /> Supplier Information</p>
          ...
          {role === "rider" && (
            <div className="bg-teal-50 rounded-2xl p-4 space-y-4">
              <p className="font-outfit font-semibold text-teal text-sm flex items-center gap-1.5"><Bike className="w-4 h-4" /> Rider Information</p>
          ...
          {role === "boat" && (
            <div className="bg-blue-50 rounded-2xl p-4 space-y-4">
              <p className="font-outfit font-semibold text-navy text-sm flex items-center gap-1.5"><Sailboat className="w-4 h-4" /> Boat Information</p>
